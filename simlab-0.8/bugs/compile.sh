...
echo $JAVAC   -classpath $REPAST_CP uchicago/src/repastdemos/heatBugs/HeatBugsModel.java
exec $JAVAC   -classpath $REPAST_CP uchicago/src/repastdemos/heatBugs/HeatBugsModel.java
